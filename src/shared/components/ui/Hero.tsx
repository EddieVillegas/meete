...
export default function Hero() {
  return (
    <section className="bg-[url(/hero.jpg)] h-150 bg-cover bg-center flex justify-center items-center">
        <div className="flex flex-col justify-center items-center max-w-2xl">
            <h1 className="text-3xl lg:text-4xl text-white uppercase font-black text-center">
                Encuentra un Meeti o Crea una Comunidad para compartir lo que mas te gusta
            </h1>
            <Link 
